...
void copyUpdatedSettingsToWork(const mxArray *mxPtr, IPRMSettings *settings)
{
  ...
  /*
  settings->max_iters = (IPRMInt)mxGetScalar(mxGetField(mxPtr, 0, "max_iters"));
  settings->bisect_iters = (IPRMInt)mxGetScalar(mxGetField(mxPtr, 0, "sigma"));
  settings->ruiz_iters = (IPRMInt)mxGetScalar(mxGetField(mxPtr, 0, "scaling"));
  settings->iter_ref_iters = (IPRMInt)mxGetScalar(mxGetField(mxPtr, 0, "adaptive_rho"));
  settings->kkt_static_reg = (IPRMFloat)mxGetScalar(mxGetField(mxPtr, 0, "adaptive_rho_interval"));
  settings->kkt_dynamic_reg = (IPRMFloat)mxGetScalar(mxGetField(mxPtr, 0, "adaptive_rho_tolerance"));
  settings->abstol = (IPRMFloat)mxGetScalar(mxGetField(mxPtr, 0, "adaptive_rho_fraction"));
  settings->reltol = (IPRMFloat)mxGetScalar(mxGetField(mxPtr, 0, "max_iter"));
  settings->abstol_inacc = (IPRMFloat)mxGetScalar(mxGetField(mxPtr, 0, "eps_abs"));
  settings->reltol_inacc = (IPRMFloat)mxGetScalar(mxGetField(mxPtr, 0, "eps_rel"));
  settings->verbose = (IPRMInt)mxGetScalar(mxGetField(mxPtr, 0, "eps_dual_inf"));
  */
}