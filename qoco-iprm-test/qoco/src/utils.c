...
unsigned char check_stopping(QOCOSolver* solver)
{
  ...
  ew_product(work->kkt->Dinvruiz, work->x, work->xbuff, data->n); /////////// 这里有点奇怪，是否是bug？
